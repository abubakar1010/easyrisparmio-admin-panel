...
const OffersMarket = () => {
  ...
  const getEditInitialValues = (offer: IOffer): Record<string, unknown> => ({
    ...
    activationCost: offer.activationCost != null ? Number(offer.activationCost) : undefined,
    fixedMonthlyFee: offer.fixedMonthlyFee != null ? Number(offer.fixedMonthlyFee) : undefined,
    pricePerKwh: offer.pricePerKwh != null ? Number(offer.pricePerKwh) : undefined,
    pricePerSmc: offer.pricePerSmc != null ? Number(offer.pricePerSmc) : undefined,
